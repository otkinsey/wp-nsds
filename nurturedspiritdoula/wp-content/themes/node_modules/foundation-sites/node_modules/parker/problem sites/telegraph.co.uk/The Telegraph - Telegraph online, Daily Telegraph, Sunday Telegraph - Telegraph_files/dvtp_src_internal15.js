...
null!==e&&(a.tags[b].ServerPublicDns=e),a.tags[b].adServingScenario=Y,a.tags[b].t2tIframeCreationTime=w,a.tags[b].t2tProcessed=!1,a.tags[b].t2tIframeId=q.id,a.tags[b].t2tIframeWindow=q.contentWindow,$dv.t2tEventDataZombie[q.id]&&(a.tags[b].uniquePageViewId=$dv.t2tEventDataZombie[q.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[q.id],a.tags[b]))}catch(g){}};for(var La,pa="auctionid vermemid incallimp source buymemid advid ioid cpgid cpid sellerid pubid siteid tagid advcode iocode cpgcode cpcode pubcode bidprc prcpaid".split(" "),
...
window._dv_win.$dv.Enums.TrafficScenario;try{if(window.top==window)return b.OnPage;if(window.top.document.domain==window.document.domain)return b.SameDomain}catch(a){}return b.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"60"}};
