...
var samLogoHeight        = "14";
var samLogoWidth         = "13"; // this is changed to 30 when logoU is replaced with logoS
...
var investorLink      = 'http://www.telegraph.co.uk/finance/investor/?WT.mc_id=tmg_nav_ros_20141212&utm_source=tmg&utm_medium=nav&utm_content=ros&utm_campaign=tmg_nav_ros_20141212';
	...
	if (samPageUser.getLoggedIn() == true || samPageUser.getLoggedIn() == "true") {
		...
		if (samPageUser.getWall() === true && samPageUser.getLoggedIn() !== true) {
			...
			if (typeof(menuDisabled) === 'boolean' && menuDisabled === true || gup('wall') === 'true' || gup('disabled') === 'true' || samPageUser.getWall() === true) {
				$(".tmgMainMenu").html("<span class='menuButtonCon'><a href='" + tmgHomeUrl + "' title='The Telegraph Home'><img src='" + samAssets + "/toolbar/images/" + samLoggedInLogo + ".png' width='" + samLogoWidth + "' height='" + samLogoHeight + "' name='" + samLoggedInLogo + "' alt='" + samLoggedInLogo + "' class='tmgMainMenuLogo'/></a><span id='" + samPrivacyPolicyMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='read our privacy and cookies policy'>" + samPrivacyPolicyMenu.getMenuName() +
				...
				"<span class='dLine'></span></span><span id='" + samInvestorMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Investor'>" + samInvestorMenu.getMenuName() +
		...
		if (samPageUser.getWall() === true && samPageUser.getLoggedIn() !== true) {
			...
			// loadWall();
				...
				$("#tmgMenu-z1").html("<div id='tmgMenuBar-z1'><div class='tmgMainMenu'><span class='menuButtonCon'><a href='" + tmgHomeUrl + "' title='The Telegraph Home'><img src='" + samAssets + "/toolbar/images/" + samLoggedOutLogo + ".png' width='" + samLogoWidth + "' height='" + samLogoHeight + "' name='" + samLoggedOutLogo + "' alt='" + samLoggedOutLogo + "' class='tmgMainMenuLogo'/></a></span><span id='" + samPrivacyPolicyMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='read our privacy and cookies policy'>" + samPrivacyPolicyMenu.getMenuName() +
				"<span class='dLine'></span></span><span id='" + samJobsMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Jobs'>" + samJobsMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samDatingMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Dating'>" + samDatingMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samOffersMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Offers'>" + samOffersMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samShopMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Shop'>" + samShopMenu.getMenuName() +
...
samInvestorMenu= new Menu({dropDown: false});
...
if (typeof (plink) == "undefined") {
	...
	// set up investor button
	samInvestorMenu.setMenuName("Investor");
	samInvestorMenu.setMenuId("investorButton");
	samInvestorMenu.setMenuClass("hiddenDrop");
...
$(document).ready(function() {
	...
	$("#investorButton").live('click', function () {
        window.location = "" + investorLink;
    });
