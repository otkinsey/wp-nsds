var pm_ppy="rt-rtcom";var pm_geo="GB";
...
var _pmpmk = 'rt-rtcom/pmk-201521001.4.js';
var _pmasync = true;
...
function getUrlParameter(name) {var match = RegExp('[?&]' + name + '=([^&]*)').exec(window.location.search);return match && decodeURIComponent(match[1].replace(/\+/g, ' '));}
 ...
 /** CJS **/ if(typeof pm_geo != "undefined" && pm_geo === "US")
{
var _pm_mcg =
{
    "d": {
    ...
    "pal": {
      "paDefault": {"sl":[['//div[not(contains(@style,"overflow:hidden"))]/following-sibling::div[contains(@class, "addthis_sharing_toolbox")]', '//div[not(contains(@style,"overflow:hidden"))]/following-sibling::div[contains(@class, "addthis_sharing_toolbox")]/following-sibling::div[contains(@class, "addthis_responsive_sharing")]']],"tl":['//div[not(contains(@style,"overflow:hidden"))]/following-sibling::div[contains(@class, "addthis_sharing_toolbox")]'],"al":["//notarealxpath"],"pl":''}
    }
