 ...
 ********************************************************************/
  ...
  $('.rowHead').click(function() {
		var categoryType = ($(this).text()).trim().replace(/ /g, '_').toLowerCase();
		categoryType = categoryType.substring(0, 1).toUpperCase()+ categoryType.substring(1, categoryType.length);
		var head = document.getElementsByTagName('head')[0];
		var s = document.createElement('script');
		s.type = 'text/javascript';
		s.text = "Krux('admEvent', 'Is6dzvgI', {accountType:'"+ categoryType + "'});";
		head.appendChild(s);
  ...
  $('.more a').click(function() {						
		var categoryType = ($(this).parents("table").prev('.rowHead').text()).trim().replace(/ /g, '_').toLowerCase();
		categoryType = categoryType.substring(0, 1).toUpperCase()+ categoryType.substring(1, categoryType.length);
		var head = document.getElementsByTagName('head')[0];
		var s = document.createElement('script');
		s.type = 'text/javascript';
		s.text = "Krux('admEvent', 'Is6hgyK-', {accountProvider:'"+ categoryType + "', accountType:'"+ categoryType + "'});";
		head.appendChild(s);
...
$(document).ready(function() {
	...
	var counthp=0;
	$('#tmglMenu #tmglHotTopics .mainNav > li .hotTopicsContent').each(function(){
...
$(function() {
	...
	***********************************************************************/
	$('.playButton a').hover(function() {
		...
		$(this).find('.playBttTop').stop().fadeTo('normal', 1);
	}, function() {
		$(this).find('.playBtt').stop().fadeTo('normal', 0);
		$(this).find('.playBttTop').stop().fadeTo('normal', 0.7);
	});
	...
	***********************************************************************/
	...
	/*$("#searchBar #otsn_search .searchBox").focus(function() {
		$("#searchBar #otsn_search .searchBox").removeClass("otsn");
	});
	$("#searchBar #otsn_search .searchBox").blur(function() {
		if( $('#searchBar #otsn_search .searchBox').val() == '' ) {
			$("#searchBar #otsn_search .searchBox").addClass("otsn");
		}
	});*/
    ...
    function setSearchBoxDefaultValue(defaultValue, elem){
		if( $(elem).val() == '' ) {
			$(elem).nextAll('.searchText.google').html('<img src="/template/ver1-0/i/search_google.png">');
            $(elem).nextAll('.searchText.new').html(defaultValue);
            $(elem).nextAll('.searchText.normal').html('Search');

		}
	};
        
	$("#searchBar #otsn_search .searchBox").blur(function() {
		setSearchBoxDefaultValue('Search - enhanced by OpenText', this);
	});
	
	$("#otsnSearch #queryText").blur(function() {
		setSearchBoxDefaultValue('Search', this);
	});
...
$(document).ready(function() {
   ...
   $(".oneThirdSpacer .fiveTwelfths").each(function(){    
          var leftGutHgt  = $(this).height();
          var rightGutHgt = $(this).nextAll('.oneQuarter').height();          
          if(leftGutHgt > rightGutHgt){
           $(".oneThirdSpacer .fiveTwelfths").nextAll('.newsBusBorder').css({"left" :"390px","height": leftGutHgt});
          }else{
           $(".oneThirdSpacer .fiveTwelfths").nextAll('.newsBusBorder').css({"left" :"390px","height": rightGutHgt});
          }        
   });
});
...
Below function will set the widths of the tabs of ms-widget
*/
...
{
    var searchVal =  $('#searchBlock form .searchBox').val();
  
    if(typeof searchVal == 'undefined'){
       searchVal  = $('#otsnSearch input#queryText').val();
       $('#otsnSearch input#queryText').val('');
       $('.searchText').html('<input class="hiddensearchBox" value=""></input>').css({"margin-left":"2px","top":"2px","width":"85%"});
       $('.hiddensearchBox').val(searchVal.replace('\\',''));
    }else{
       $('#searchBlock form .searchBox').val('');
       $('.searchText').html('<input class="hiddensearchBox" value='+searchVal+'></input>').css("margin-left","0");
...
function  autoRefreshTrigger(triggerTime){
   var pageURL = window.location.href;
   if(pageURL.indexOf('#source=refresh')!=-1){
      pageURL = window.location.href;
   }else{      
      pageURL = window.location.href+'#source=refresh';
   } 
       setTimeout(function(){          
...
function startTrigger(){
	...
	if($('#autoRefreshTrigger').length > 0 && pageType == 'section'){
	  triggerTime = $('#autoRefreshTrigger').val();
	  triggerTime = parseInt(triggerTime)*1000;    
	  autoRefreshTrigger(triggerTime);
	}}
