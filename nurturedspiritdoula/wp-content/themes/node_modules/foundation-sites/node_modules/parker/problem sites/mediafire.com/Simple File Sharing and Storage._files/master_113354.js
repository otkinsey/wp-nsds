BUILD_VERSION='113354';
 
var II='cdn.mediafire.com'; var pq='';function qc(mG){var qd=document.getElementById('reg_email');var my=document.getElementById('login_email');if(qd)qd.value=mG;if(my)my.value=mG;return false;};function qa(iL){var gN=document.getElementById('login_type');var fQ=document.getElementById('signin_register');if(!gN|| !fQ)
